...
(defn delete-coupon [{:keys [coupon-id]}]
  "Delete a coupon
  ...
  Path Parameters:
    - coupon-id: The coupon-id parameter. (required) [type: string]
...
(defn retrieve-coupon [{:keys [coupon-id query-params]}]
  "Retrieve a coupon
...
(defn update-coupon [{:keys [coupon-id]}]
  "Update a coupon
