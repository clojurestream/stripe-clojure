...
(defn list-all-search
  ...
  Query Parameters:
    ...
    - query (String): The search query string. See [search query language](https://stripe.com/docs/search#search-query-language) and the list of supported [query fields for subscriptions](https://stripe.com/docs/search#query-fields-for-subscriptions). (required)
...
(defn list-all
  ...
  Query Parameters:
    ...
    - current-period-end (Unknown): Only return subscriptions whose current_period_end falls within the given date interval.
    - current-period-start (Unknown): Only return subscriptions whose current_period_start falls within the given date interval.
