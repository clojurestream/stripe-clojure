...
(defn list-all-credit-notes-preview-lines
  ...
  Query Parameters:
    - amount (Integer): The integer amount in cents (or local equivalent) representing the total amount of the credit note.
    ...
    - shipping-cost (Object): When shipping_cost contains the shipping_rate from the invoice, the shipping_cost is included in the credit note.
